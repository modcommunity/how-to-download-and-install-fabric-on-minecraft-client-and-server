...
- [Installing](#installing)
    ...
    - [Server](#server)
        - [Through the GUI Installer](#through-the-gui-installer-1)
        - [Through the Command Line (Linux/PowerShell)](#through-the-command-line-linuxpowershell-1)
- [Running](#running)
    - [Client](#client-1)
    - [Server](#server-1)
- [Notes](#notes)
    - [Fabric API Mod (Recommended)](#fabric-api-mod-recommended)
    - [Using Screen (Linux)](#using-screen-linux)
- [See Also](#see-also)
